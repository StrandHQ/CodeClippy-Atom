...
export default {
  ...
  activate(state) {
    ...
    // Register when active text editor changes
  ...
  handleEditorChange(editor) {
    this.searchView.handleEditorChange(editor);
  },
  ...
  toggle() {
    this.searchView.handleEditorChange(atom.workspace.getActiveTextEditor());
    return (
